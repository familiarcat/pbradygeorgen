...
export default async function handler(
  ...
  try {
    ...
    if (!fs.existsSync(aiAnalysisPath)) {
      DanteLogger.error.system('Summary file not found');
    ...
    DanteLogger.success.core('Summary loaded successfully');
    ...
    DanteLogger.error.system(`Error loading summary: ${errorMessage}`);
