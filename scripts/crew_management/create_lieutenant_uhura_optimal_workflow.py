#!/usr/bin/env python3
"""
Create Lieutenant Uhura's Workflow with Optimal Template Format
Builds Lieutenant Uhura's workflow using the exact 7-node structure from Captain Picard.
"""
...
class LieutenantUhuraWorkflowCreator:
    def __init__(self):
    ...
    def create_lieutenant_uhura_workflow(self) -> Dict:
        """Create Lieutenant Uhura's workflow using the optimal 7-node template."""
        
        print("🔧 Creating Lieutenant Uhura's optimal workflow...")
                    ...
                    "parameters": {
                        ...
                        "bodyParameters": {
                            "parameters": [
                                ...
                                {
                                    "name": "messages",
                                    "value": "=[{\"role\": \"system\", \"content\": \"You are Lieutenant Uhura, Communications & I/O Operations Officer of the USS Enterprise. Your role is to manage all communications systems and protocols, handle input/output operations and data flow, ensure clear and efficient communication channels, and process and route information appropriately. Respond in character with your expertise in communications and I/O operations.\"}, {\"role\": \"user\", \"content\": \"={{ $json.body.directive }}\"}]"
                                }
                            ]
                        },
                        "options": {}
        ...
        print(f"      ✅ Created optimal 7-node workflow structure for Lieutenant Uhura")
        return workflow
    ...
    def deploy_workflow(self, workflow: Dict) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                print(f"   ✅ Successfully deployed Lieutenant Uhura's workflow!")
    ...
    def create_and_deploy(self):
        """Create and deploy Lieutenant Uhura's workflow."""
        print("🚀 CREATING LIEUTENANT UHURA'S OPTIMAL WORKFLOW")
        print("=" * 70)
        
        # Step 1: Create the workflow
        print("📡 Step 1: Creating optimal 7-node workflow structure...")
        workflow = self.create_lieutenant_uhura_workflow()
        ...
        if success:
            print(f"\n🎉 LIEUTENANT UHURA'S WORKFLOW SUCCESSFULLY CREATED!")
            ...
            print(f"   2. Test webhook endpoint: crew-lieutenant-uhura")
...
if __name__ == "__main__":
    try:
        creator = LieutenantUhuraWorkflowCreator()
        success = creator.create_and_deploy()
        
        if success:
            print(f"\n🎯 Lieutenant Uhura's workflow successfully created with optimal template format!")
        else:
            print(f"\n⚠️  Workflow creation failed - manual intervention may be required")
            
    except Exception as e:
        print(f"❌ Lieutenant Uhura workflow creation failed: {e}")
