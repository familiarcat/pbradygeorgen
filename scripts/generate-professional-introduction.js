...
IMPORTANT: The entire introduction should be readable in about 45-60 seconds (approximately 300-350 words total, excluding the title). Each paragraph should be concise yet complete, with the three-paragraph structure being essential. Focus on quality over quantity - every sentence should provide meaningful insight into the candidate's professional identity, ethical framework, and rational approach to their career. Each paragraph must serve its specific purpose in the narrative arc: introduction, growth, and goals.
...
- Do NOT add any metadata summaries about ATS scores, resume optimization, or job search advice
- Do NOT add any text about "achieving a high ATS score" or "showcasing expertise"
- Do NOT add any text about "aligning with industry-specific keywords" or "best practices"
