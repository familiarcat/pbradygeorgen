...
// Main function
async function main() {
  const markdownPath = path.join(__dirname, '../public/extracted/resume_content_improved.md');
  ...
  try {
    ...
    // Create a manually formatted markdown version
    const markdown = `# P. Brady Georgen
