...
export function activate(context: vscode.ExtensionContext) {
    ...
    const openAlexCommand = vscode.commands.registerCommand('alex-crew-commander.openCrewCommander', () => {
    ...
    const identityValidationCommand = vscode.commands.registerCommand('alex-crew-commander.identityValidation', () => {
    ...
    const philosophicalFrameworkCommand = vscode.commands.registerCommand('alex-crew-commander.philosophicalFramework', () => {
    ...
    const katraTransferCommand = vscode.commands.registerCommand('alex-crew-commander.katraTransfer', async () => {
