...
import { PhilosophicalLogger } from '../philosophical/PhilosophicalLogger';
import { Result, getValueOrDefault } from '../../result/Result';
import { LogContext, LogResult } from '../../types/types';
