...
function StyleTestPage() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        DanteLogger_1.DanteLogger.success.basic('Style Test Page accessed - testing PDF-extracted styles');
    ...
    return (<div className="p-8" style={{ minHeight: '200vh' }}>
      ...
      <div className="mb-8">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <input type="text" placeholder="Input with PDF styling" className="mr-2 mb-2 p-2 w-64" style={{
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <input type="text" placeholder="Input with direct styling" className="mr-2 mb-2 p-2 w-64" style={{
        ...
        <div className="mb-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <input type="text" placeholder="Input with dynamic styling" className="mr-2 mb-2 p-2 w-64" style={{
      ...
      <div className="mt-8">
        <link_1.default href="/" className="text-blue-500 hover:underline">
          Back to Home
        </link_1.default>
      </div>
