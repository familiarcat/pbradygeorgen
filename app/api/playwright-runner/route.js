...
function getTestFileForSuite(suite) {
    const suiteMap = {
...
function runPlaywrightTests(args) {
    return new Promise((resolve, reject) => {
        ...
        const childProcess = (0, child_process_1.spawn)('npx', ['playwright', ...args], {
            cwd: processCwd,
...
function transformPlaywrightResults(jsonData) {
...
function generateMockResults(withFailures = false) {
