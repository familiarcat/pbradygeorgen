...
async function POST(request) {
    try {
        ...
        if (!crewMemberId || !webhookPath || !task) {
            return server_1.NextResponse.json({ error: 'Missing required fields: crewMemberId, webhookPath, task' }, { status: 400 });
        }
...
async function generateMockCrewResponse(crewMemberId, task) {
