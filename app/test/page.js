...
function TestPage() {
    ...
    const handleCategorySelect = (category) => {
        ...
        DanteLogger_1.DanteLogger.success.ux(`Selected category: ${category}`);
    };
    const handleTestPdfSelect = (category, id) => {
        ...
        DanteLogger_1.DanteLogger.success.core(`Selected test PDF: ${id} from ${category} category`);
    ...
    return (<div className="min-h-screen bg-[var(--bg-primary, #f5f5f5)] py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mb-6">
              <div className="flex flex-wrap gap-2 mb-6">
                {Object.keys(TEST_PDFS).map((category) => (<button key={category} onClick={() => handleCategorySelect(category)} className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${selectedCategory === category
              ...
              {selectedCategory && (<div className="space-y-4">
                  ...
                  <div className="grid gap-3">
                    {TEST_PDFS[selectedCategory].map((pdf) => (<button key={pdf.id} onClick={() => handleTestPdfSelect(selectedCategory, pdf.id)} className="flex flex-col text-left p-4 border border-[var(--border-primary, #eaeaea)] rounded-lg hover:bg-[var(--bg-secondary, #f0f0f0)] transition-colors">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {!uploadSuccess ? (<PDFUploader_1.default onPdfUploaded={handlePdfUploaded} className="mb-4"/>) : (<div className="text-center p-6 bg-[var(--state-success-light, #e6f7e6)] rounded-lg mb-4">
        ...
        <div className="text-center">
          <link_1.default href="/" className="inline-flex items-center text-[var(--text-secondary, #666)] hover:text-[var(--text-primary, #333)] transition-colors">
