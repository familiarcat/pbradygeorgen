...
const PDFStylesDisplay_1 = __importDefault(require("@/components/PDFStylesDisplay"));
const link_1 = __importDefault(require("next/link"));
const Navigation_1 = __importDefault(require("@/components/Navigation"));
function PDFStylesPage() {
    return (<div className="pdf-styles-page">
      ...
      <main>
        <section className="intro-section">
          ...
          <div className="cta-container">
            <link_1.default href="/" className="cta-button primary">
              View Resume
            </link_1.default>
            <link_1.default href="/upload" className="cta-button secondary">
              Upload New PDF
            </link_1.default>
          </div>
        </section>

        <PDFStylesDisplay_1.default />
