      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                ...
                disabled={isAnalyzing || !youtubeUrl || !githubRepo}
                className="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-semibold py-4 px-6 rounded-lg transition duration-300 flex items-center justify-center"
              >
                {isAnalyzing ? (
                  <>
              ...
              <button
                ...
                disabled={isAnalyzing}
                className="bg-orange-500 hover:bg-orange-600 disabled:bg-gray-400 text-white font-semibold py-4 px-6 rounded-lg transition duration-300"
              >
                🎯 Load Demo
              </button>
            </div>
        ...
        {result && (
          <div className="space-y-8">
            ...
            {/* Content Gaps */}
            {result.comparison_result.content_gaps.length > 0 && (
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">⚠️ Content Gaps Identified</h2>
                <div className="space-y-3">
                  {result.comparison_result.content_gaps.map((gap, index) => (
            ...
            {/* Recommendations */}
            {result.comparison_result.recommendations.length > 0 && (
              <div className="bg-white rounded-xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">💡 Recommendations</h2>
                <div className="space-y-3">
                  {result.comparison_result.recommendations.map((rec, index) => (
