...
class EnhancedUnifiedRouter:
    """
    Enhanced router that integrates local Claude agents with OpenRouter
    ...
    def __init__(self):
        ...
        # Local Claude crew members mapping
        self.local_crew_members = {
            "strategic_planning": {
                "name": "Captain Jean-Luc Picard",
                "role": "Strategic Leadership",
                "specialization": "High-level strategy and planning",
                "capabilities": ["strategic_thinking", "leadership", "ethical_decision_making"],
            ...
            "complex_analysis": {
                ...
                "specialization": "Complex problem analysis and logical reasoning",
                "capabilities": ["logical_analysis", "data_processing", "problem_solving"],
                "model": "claude-3-5-sonnet-20241022",
                "confidence": 0.99
            },
            "system_architecture": {
                ...
                "role": "Chief Engineer",
                "specialization": "System design and engineering solutions",
                "capabilities": ["engineering", "system_design", "technical_optimization"],
                "model": "claude-3-5-sonnet-20241022",
                "confidence": 0.98
            },
            "code_implementation": {
                ...
                "specialization": "Live coding and IDE integration",
        ...
        print("Enhanced Unified Router initialized", file=sys.stderr)
    ...
    def analyze_task(self, task_description: str, task_context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        # Determine task type
        task_type = "general"
        if any(word in task_lower for word in ["strategy", "plan", "architect", "design"]):
            task_type = "strategic_planning"
        elif any(word in task_lower for word in ["analyze", "investigate", "research", "examine"]):
            task_type = "complex_analysis"
        elif any(word in task_lower for word in ["system", "architecture", "infrastructure", "engineering"]):
            task_type = "system_architecture"
        elif any(word in task_lower for word in ["code", "implement", "function", "class", "refactor"]):
            task_type = "code_implementation"
        elif any(word in task_lower for word in ["quick", "simple", "basic"]):
            task_type = "quick_analysis"
        
        # Determine complexity
        complexity = "medium"
        if len(task_description.split()) > 100 or any(word in task_lower for word in ["complex", "advanced", "sophisticated"]):
            complexity = "high"
        elif len(task_description.split()) < 20 or any(word in task_lower for word in ["simple", "basic", "quick"]):
            complexity = "low"
    ...
    def _is_model_suitable_for_task(self, model_info: Dict[str, Any], task_type: str) -> bool:
        ...
        if task_type == "code_implementation":
            ...
            return "quick_response" in model_info.get("strengths", [])
        else:
    ...
    def execute_with_local_claude(self, task_description: str, crew_member: Dict[str, Any], context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            # Build system prompt for crew member
...
Be specific, actionable, and maintain the character of your Star Trek role."""
    ...
    def route_task(self, task_description: str, context: Dict[str, Any] = None, budget_constraints: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Step 4: Compile final result with UI enhancements
            return {
                "success": True,
                "task_analysis": task_analysis,
                "llm_selection": llm_selection,
