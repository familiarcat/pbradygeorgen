...
exports.getGoldenRatioColor = getGoldenRatioColor;
exports.generateCtaBackground = generateCtaBackground;
exports.generateSalingerCtaColors = generateSalingerCtaColors;
exports.analyzeColorContrast = analyzeColorContrast;
...
function getGoldenRatioColor(color) {
...
function generateCtaBackground(baseColor, textColor = '#FFFFFF') {
    ...
    if (contrastRatio < 4.5) {
        ...
        DanteLogger_1.DanteLogger.success.ux(`Applied Derrida's différance to CTA color. Contrast ratio: ${contrastRatio.toFixed(2)}:1`);
    }
    return ctaColor;
}
function generateSalingerCtaColors(baseColor) {
    ...
    DanteLogger_1.DanteLogger.success.core(`Generated Salinger CTA colors using Hesse method from base: ${baseColor}`);
    return {
        primary: {
            base: primaryColor,
...
function analyzeColorContrast(colors) {
    ...
    if (primaryContrast >= 7) {
        DanteLogger_1.DanteLogger.success.perfection(`Primary CTA contrast: ${primaryContrast.toFixed(2)}:1 (AAA)`);
    }
    else if (primaryContrast >= 4.5) {
        DanteLogger_1.DanteLogger.success.core(`Primary CTA contrast: ${primaryContrast.toFixed(2)}:1 (AA)`);
    }
    else {
        DanteLogger_1.DanteLogger.warn.performance(`Primary CTA contrast: ${primaryContrast.toFixed(2)}:1 (Below AA)`);
    }
    if (secondaryContrast >= 7) {
        DanteLogger_1.DanteLogger.success.perfection(`Secondary CTA contrast: ${secondaryContrast.toFixed(2)}:1 (AAA)`);
    }
    else if (secondaryContrast >= 4.5) {
        DanteLogger_1.DanteLogger.success.core(`Secondary CTA contrast: ${secondaryContrast.toFixed(2)}:1 (AA)`);
    }
    else {
        DanteLogger_1.DanteLogger.warn.performance(`Secondary CTA contrast: ${secondaryContrast.toFixed(2)}:1 (Below AA)`);
    }
    if (tertiaryContrast >= 7) {
        DanteLogger_1.DanteLogger.success.perfection(`Tertiary CTA contrast: ${tertiaryContrast.toFixed(2)}:1 (AAA)`);
    }
    else if (tertiaryContrast >= 4.5) {
        DanteLogger_1.DanteLogger.success.core(`Tertiary CTA contrast: ${tertiaryContrast.toFixed(2)}:1 (AA)`);
    }
    else {
        DanteLogger_1.DanteLogger.warn.performance(`Tertiary CTA contrast: ${tertiaryContrast.toFixed(2)}:1 (Below AA)`);
    }
}
exports.default = {
    hexToRgb,
...
//# sourceMappingURL=HesseColorTheory.js.map