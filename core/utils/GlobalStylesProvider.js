...
function GlobalStylesProvider({ children }) {
    const [colorTheory, setColorTheory] = (0, react_1.useState)(defaultColorTheory);
    const [fontTheory, setFontTheory] = (0, react_1.useState)(defaultFontTheory);
    ...
    return (<div className="pdf-styles-provider pdf-styles-loaded" style={{
