...
exports.default = PDFStylingDemoPage;
...
async function PDFStylingDemoPage() {
    // Load the color theme from the extracted directory
    let colorTheme = { ...defaultColorTheme, isLoading: false };
    let fontTheme = defaultFontTheme;
    try {
    ...
    return (<div className="pdf-styling-demo" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      <div>
        <h1 style={{
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        ].map((item, index) => (<div key={item.name} style={{
                width: '120px',
                textAlign: 'center'
            }}>
              <div style={{
