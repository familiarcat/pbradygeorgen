 ...
 */
const DirectStyleInjector = () => {
    const [stylesInjected, setStylesInjected] = (0, react_1.useState)(false);
    ...
    (0, react_1.useEffect)(() => {
        const injectStyles = async () => {
            ...
            try {
                ...
                DanteLogger_1.DanteLogger.success.basic('DirectStyleInjector: Starting style injection');
                ...
                try {
                    ...
                    if (colorResponse.ok) {
                        ...
                        DanteLogger_1.DanteLogger.success.basic('DirectStyleInjector: Loaded color theory');
                    }
                    else {
                    ...
                    DanteLogger_1.DanteLogger.error.dataFlow(`DirectStyleInjector: Failed to load color theory: ${colorError}`);
                ...
                try {
                    ...
                    if (fontResponse.ok) {
                        ...
                        DanteLogger_1.DanteLogger.success.basic('DirectStyleInjector: Loaded font theory');
                    }
                    else {
                    ...
                    DanteLogger_1.DanteLogger.error.dataFlow(`DirectStyleInjector: Failed to load font theory: ${fontError}`);
                ...
                DanteLogger_1.DanteLogger.success.ux('DirectStyleInjector: Styles injected successfully');
                ...
                DanteLogger_1.DanteLogger.error.runtime(`DirectStyleInjector: Error injecting styles: ${errorMessage}`);
            }
        };
        // Initial injection
        injectStyles();
        ...
        const handleForceInjection = () => {
            ...
            DanteLogger_1.DanteLogger.error.runtime('DirectStyleInjector: Force style injection event received');
            injectStyles();
        };
    ...
    const generateCssContent = (colorTheory, fontTheory) => {
        return `
...
exports.default = DirectStyleInjector;
//# sourceMappingURL=DirectStyleInjector.js.map