 ...
 */
const StyleDebugger = () => {
    const [cssVariables, setCssVariables] = (0, react_1.useState)([]);
    ...
    const renderColorPreview = (value) => {
    ...
    return (<div style={{ padding: '20px', fontFamily: 'var(--font-mono, monospace)' }}>
      ...
      <div style={{ marginBottom: '20px', display: 'flex', gap: '10px', alignItems: 'center' }}>
        <input type="text" placeholder="Filter variables..." value={filter} onChange={(e) => setFilter(e.target.value)} style={{
            padding: '8px 12px',
            width: '100%',
            maxWidth: '400px',
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <button onClick={() => setRefreshCount(prev => prev + 1)} style={{
            padding: '8px 16px',
      ...
      {Object.keys(groupedVariables).map(category => (<div key={category} style={{ marginBottom: '30px' }}>
          <h2 style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            {groupedVariables[category].map(variable => (<div key={variable.name} style={{
                    padding: '10px',
      ...
      {Object.keys(groupedVariables).length === 0 && (<div style={{
                padding: '20px',
                backgroundColor: 'var(--bg-secondary, #f9f9f9)',
                borderRadius: '4px',
                textAlign: 'center'
...
exports.default = StyleDebugger;
//# sourceMappingURL=StyleDebugger.js.map