    ...
    (0, react_1.useEffect)(() => {
        const loadPdfStyles = async () => {
            try {
                ...
                // Log success
                DanteLogger_1.DanteLogger.success.basic('PDF fonts CSS loaded successfully');
                ...
                // Log error
                DanteLogger_1.DanteLogger.error.dataFlow(`Failed to load PDF fonts CSS: ${err}`);
...
exports.default = PdfStyleLoader;
//# sourceMappingURL=PdfStyleLoader.js.map