...
interface BusinessPlanDesignerProps { }

const BusinessPlanDesigner: React.FC<BusinessPlanDesignerProps> = () => {
    const [businessIdea, setBusinessIdea] = useState('');
    const [generatedBusinessModel, setGeneratedBusinessModel] = useState<BusinessModel | null>(null);
    const [selectedTheme, setSelectedTheme] = useState<BusinessTheme | null>(null);
    const [isGenerating, setIsGenerating] = useState(false);
    const [currentStep, setCurrentStep] = useState<'idea' | 'model' | 'theme' | 'interface' | 'roadmap'>('idea');
    ...
    const generateBusinessModel = useCallback(async () => {
    ...
    const selectTheme = useCallback((theme: BusinessTheme) => {
        ...
        <div style={{
            ...
            <main style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                {['idea', 'model', 'theme', 'interface', 'roadmap'].map((step, index) => (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        {/* Welcome State */}
                        {!generatedBusinessModel && currentStep === 'idea' && (
                            <div style={{
                                background: 'rgba(255, 255, 255, 0.9)',
                                backdropFilter: 'blur(20px)',
                                borderRadius: '24px',
                        ...
                        {currentStep === 'interface' && selectedTheme && (
                            <div style={{
                                background: 'rgba(255, 255, 255, 0.9)',
                                backdropFilter: 'blur(20px)',
                                borderRadius: '24px',
                                ...
                                <div style={{
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
                                        {selectedTheme.interfaceElements.map((element, index) => (
                                            <div key={index} style={{
...
export default BusinessPlanDesigner;
