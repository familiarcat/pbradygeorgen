 ...
 */
const PdfStylesInitializer = () => {
    const [stylesLoaded, setStylesLoaded] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    (0, react_1.useEffect)(() => {
        const initializeStyles = async () => {
            try {
                DanteLogger_1.DanteLogger.success.basic('PdfStylesInitializer: Starting style initialization');
                ...
                try {
                    ...
                    if (colorResponse.ok) {
                        ...
                        DanteLogger_1.DanteLogger.success.basic('PdfStylesInitializer: Loaded color theory');
                    ...
                    DanteLogger_1.DanteLogger.error.dataFlow(`PdfStylesInitializer: Failed to load color theory: ${colorError}`);
                ...
                try {
                    ...
                    if (fontResponse.ok) {
                        ...
                        DanteLogger_1.DanteLogger.success.basic('PdfStylesInitializer: Loaded font theory');
                    ...
                    DanteLogger_1.DanteLogger.error.dataFlow(`PdfStylesInitializer: Failed to load font theory: ${fontError}`);
                ...
                if (colorTheory || fontTheory) {
                    ...
                    DanteLogger_1.DanteLogger.success.ux('PdfStylesInitializer: Applied PDF styles to document');
                ...
                DanteLogger_1.DanteLogger.error.runtime(`PdfStylesInitializer: Error initializing styles: ${errorMessage}`);
    ...
    const applyStylesToDocument = (colorTheory, fontTheory) => {
...
exports.default = PdfStylesInitializer;
//# sourceMappingURL=PdfStylesInitializer.js.map