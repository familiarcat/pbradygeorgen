...
exports.default = CeremonyGuide;
const react_1 = require("react");
const DanteLogger_1 = require("@/utils/DanteLogger");
function CeremonyGuide() {
    const [activeCeremony, setActiveCeremony] = (0, react_1.useState)('planning');
    const handleCeremonyChange = (ceremony) => {
        setActiveCeremony(ceremony);
        DanteLogger_1.DanteLogger.success.ux(`Viewing ${ceremony} ceremony guide`);
    };
    return (<div className="space-y-8">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          <button onClick={() => handleCeremonyChange('planning')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeCeremony === 'planning'
          ...
          <button onClick={() => handleCeremonyChange('standup')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeCeremony === 'standup'
            ? 'bg-[var(--cta-primary, #0070f3)] text-white'
            : 'bg-[var(--bg-secondary, #f0f0f0)] text-[var(--text-secondary, #666)] hover:bg-[var(--bg-tertiary, #e0e0e0)]'}`}>
            Daily Stand-up
          </button>
          <button onClick={() => handleCeremonyChange('review')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeCeremony === 'review'
            ? 'bg-[var(--cta-primary, #0070f3)] text-white'
            : 'bg-[var(--bg-secondary, #f0f0f0)] text-[var(--text-secondary, #666)] hover:bg-[var(--bg-tertiary, #e0e0e0)]'}`}>
            Sprint Review
          </button>
          <button onClick={() => handleCeremonyChange('retro')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeCeremony === 'retro'
            ? 'bg-[var(--cta-primary, #0070f3)] text-white'
            : 'bg-[var(--bg-secondary, #f0f0f0)] text-[var(--text-secondary, #666)] hover:bg-[var(--bg-tertiary, #e0e0e0)]'}`}>
            Sprint Retrospective
          </button>
          <button onClick={() => handleCeremonyChange('refinement')} className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${activeCeremony === 'refinement'
            ? 'bg-[var(--cta-primary, #0070f3)] text-white'
            : 'bg-[var(--bg-secondary, #f0f0f0)] text-[var(--text-secondary, #666)] hover:bg-[var(--bg-tertiary, #e0e0e0)]'}`}>
            Backlog Refinement
          </button>
        ...
        {activeCeremony === 'planning' && (<div className="space-y-6">
        ...
        {activeCeremony === 'standup' && (<div className="space-y-6">
            <div className="flex items-center">
              <div className="text-3xl mr-4">⏱️</div>
              <h3 className="text-xl font-bold text-[var(--text-primary, #333)]">
        ...
        {activeCeremony === 'review' && (<div className="space-y-6">
            <div className="flex items-center">
              <div className="text-3xl mr-4">👁️</div>
              <h3 className="text-xl font-bold text-[var(--text-primary, #333)]">
        ...
        {activeCeremony === 'retro' && (<div className="space-y-6">
            <div className="flex items-center">
        ...
        {activeCeremony === 'refinement' && (<div className="space-y-6">
            <div className="flex items-center">
              <div className="text-3xl mr-4">✂️</div>
              <h3 className="text-xl font-bold text-[var(--text-primary, #333)]">
...
//# sourceMappingURL=CeremonyGuide.js.map